...
public class CheckoutPageTest extends baseTest {
    ...
    public void testCheckoutPage() {
        ...
        checkoutPage.setFirstName("Arpitha");
        checkoutPage.setLastName("S");
        checkoutPage.setAddress("Bangalore, Sarjapura");
        ...
        checkoutPage.setEmailAddress("arpithass139@gmail.com");
        checkoutPage.setMobileNumber("7892623048");
